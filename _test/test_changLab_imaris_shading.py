...
if __name__ == "__main__":
    ...
    for img_idx in range(nimgs):
        ...
        imaris.ims_from_ims(corrected_stack, os.path.join(img_folder, img_list[img_idx]), os.path.join(save_folder, img_list[img_idx]))
            # img_util.write_img(os.path.join(save_folder, f'test_{img_idx}.tiff'), img[0, 0, :, :, :])
