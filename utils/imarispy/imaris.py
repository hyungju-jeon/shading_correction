...
def ims_from_ims(img, in_name:str, out_name:str):
    ...
    attrs = [
        ...
        ('DataSetInfo/Image', ('Description', in_ims.read_attribute('DataSetInfo/Image', 'Description'))),
        ('DataSetInfo/Image', ('RecordingDate', in_ims.read_attribute('DataSetInfo/Image', 'RecordingDate'))),
        ...
        ('DataSetInfo/Image', ('LensPower', in_ims.read_attribute('DataSetInfo/Image', 'LensPower'))),
        ('DataSetInfo/TimeInfo', ('DatasetTimePoints', in_ims.read_attribute('DataSetInfo/TimeInfo', 'DatasetTimePoints'))),
        ('DataSetInfo/TimeInfo', ('FileTimePoints', in_ims.read_attribute('DataSetInfo/TimeInfo', 'FileTimePoints'))),
    ]
    ...
    for ch in range(num_ch):
        ...
        attrs.append((ch_field, ('GammaCorrection', in_ims.read_attribute(ch_field, 'GammaCorrection'))))
