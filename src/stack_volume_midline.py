...
if __name__ == "__main__":
    ...
    brain_infofile = brain_info.read_midline_info(info_file_midline, ratio = 16)
    ...
    for new_img in rotated_list:
        ...
        new_img = img_util.pad_img(new_img, des_height = img_height, des_width = img_width)
        rotated_pad_list.append(new_img)
        
    rotated_volume = np.stack(rotated_pad_list, axis=0)    
    print(rotated_volume.shape)
    
    img_util.write_img(filename= '/users/Yoonkyoung/Desktop/041715_JK359-2_L/code_test_midline_stack_whole.tiff', 
                       img_data = rotated_volume)
   
    print('starting y-translation registration')
    #y-direction translation
    stack_volume_ZImg = ZImg('/users/Yoonkyoung/Desktop/041715_JK359-2_L/code_test_midline_stack_whole.tiff')
    ...
    img_util.write_img(filename= '/users/Yoonkyoung/Desktop/041715_JK359-2_L/code_test_3D_midline.tiff', 
